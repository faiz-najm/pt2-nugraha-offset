package com.d3if4503.typewriter.utils;

public class Constants {
     public static String API_BASE_URL = "https://adminpt2.000webhostapp.com";
//    public static String API_BASE_URL = "http://adminng.000.pe/sample_ecom";
    ...
    public static String FIREBASE_DB = "https://pt2-nugrahaoffset-default-rtdb.asia-southeast1.firebasedatabase.app";
