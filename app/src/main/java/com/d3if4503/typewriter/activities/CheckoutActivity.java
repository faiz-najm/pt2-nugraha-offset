...
import com.d3if4503.typewriter.adapters.CartAdapter;
...
public class CheckoutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CartAdapter(this, products, () -> binding.subtotal.setText(formatCurrencyId(cart.getTotalPrice())));
        ...
        binding.subtotal.setText(formatCurrencyId(cart.getTotalPrice()));

        totalPrice = (cart.getTotalPrice().doubleValue() * tax / 100) + cart.getTotalPrice().doubleValue();
        binding.total.setText(formatCurrencyId(totalPrice));
